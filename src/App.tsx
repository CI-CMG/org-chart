...
const meta_graph = {
  ...
  links: [
    ...
    { source: "Alison Post", target: "Earth Lab", predicate: "memberOf" },
    ...
    { source: "Chris Slater", target: "WOD", predicate: "memberOf" },
    {
      source: "Clinton Campbell",
      target: "GSB Dev Team",
      predicate: "memberOf",
    ...
    { source: "Errol Ronje", target: "OSB", predicate: "memberOf", value: 1 },
