...
const meta_graph = {
  "nodes": [
    ...
    {"id": "SEEC", "longName": "Sustainability, Energy and Environment Community (SEEC)", "group": 2},
      {"id": "Earth Lab", "longName": "Earth Lab", "group": 2},
    {"id": "Main Campus Research", "longName": "", "group": 2},
    {"id": "CEEE", "longName": "Center for Education, Engagement and Evaluation (CEEE)", "group": 2},
    {"id": "NSIDC", "longName": "National Snow and Ice Data Center (NSIDC)", "group": 2},
    {"id": "SWPC", "longName": "Space Weather Prediction Center (SWPC)", "group": 2},
    ...
    {"id": "NCEI", "group": 2},
    {"id": "Directors Office", "longName": "NCEI Directors Office (DO)", "group": 2},
      {"id": "Derek Arndt", "group": 0},
      {"id": "Joseph Pica", "group": 0},
    //
    {"id": "CSSD", "longName": "Climate Science and Services Division (CSSD)", "group": 2},
      {"id": "CSB", "longName": "Climate Science Branch (CSB)", "group": 2},
      {"id": "CISB", "longName": "Climate Information Services Branch (CISB)", "group": 2},
      {"id": "MAB", "longName": "Monitoring & Assessment Branch (MAB)", "group": 2},
    //
    {"id": "COGS", "longName": "Coasts, Oceans, and Geophysics Science Division (COGS)", "group": 2},
    ...
    {"id": "RMD", "longName": "Resource Management Division (RMD)", "group": 2},
      ...
      {"id": "FAB", "longName": "Finance and Administrative Branch (FAB)", "group": 2},
        {"id": "Ming-Wai Merschat", "group": 0}, // Mindful NOAA
      {"id": "SEB", "longName": "Standards and Evaluation Branch (SEB)", "group": 2},
        // {"id": "", "group": 0},
      {"id": "COB", "longName": "Communications and Outreach Branch (COB)", "group": 2},
    ...
    {"id": "CIRES", "longName": "Cooperative Institute for Research in Environmental Sciences", "group": 5},
    {"id": "National Environmental Satellite, Data, and Information Service", "longName": "National Environmental Satellite, Data, and Information Service (NESDIS)", "group": 5},
    {"id": "NOAA", "longName": "National Oceanic and Atmospheric Administration", "group": 5},
    {"id": "Office of Ocean and Atmospheric Research", "longName": "Office of Ocean and Atmospheric Research (OAR)", "group": 5},
    {"id": "CU", "longName": "University of Colorado Boulder", "group": 5},
    {"id": "NCEP", "longName": "National Centers for Environmental Prediction (NCEP)", "group": 5},
